...
public class SDL {
    ...
    static void loadLibrary(String libraryName, Context context)
        ...
        try {
            ...
            Class<?> relinkListenerClass =
                context.getClassLoader().loadClass("com.getkeepsafe.relinker.ReLinker$LoadListener");
            ...
            Method loadMethod = relinkInstanceClass.getDeclaredMethod(
