...
class HIDDeviceUSB implements HIDDevice {
    ...
    public String getSerialNumber() {
        ...
        try {
            ...
            // Log.w(TAG, "App permissions mean we cannot get serial number for device " + getDeviceName() + " message:
    ...
    String getDeviceName() {
        return getManufacturerName() + " " + getProductName() + "(0x" + String.format("%x", getVendorId()) + "/0x" +
            String.format("%x", getProductId()) + ")";
    }
    ...
    public int writeReport(byte[] report, boolean feature) {
        ...
        if (feature) {
            ...
            res = mConnection.controlTransfer(UsbConstants.USB_TYPE_CLASS | 0x01 /*RECIPIENT_INTERFACE*/ |
