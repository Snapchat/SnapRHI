...
class HIDDeviceBLESteamController extends BluetoothGattCallback implements HIDDevice {
    ...
    static class GattOperation {
        private enum Operation { CHR_READ, CHR_WRITE, ENABLE_NOTIFICATION }
    ...
    // Because on Chromebooks we show up as a dual-mode device, it will attempt to connect TRANSPORT_AUTO, which will
    // use TRANSPORT_BREDR instead of TRANSPORT_LE.  Let's force ourselves to connect low energy.
    ...
    public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
        ...
        if (characteristic.getUuid().equals(reportCharacteristic)) {
            ...
            if (!isRegistered()) {
                ...
                mManager.HIDDeviceConnected(getId(),
                                            getIdentifier(),
                                            getVendorId(),
                                            getProductId(),
                                            getSerialNumber(),
    ...
    public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
        ...
        // Log.v(TAG, "onCharacteristicChanged uuid=" + characteristic.getUuid() + " data=" +
        // HexDump.dumpHexString(characteristic.getValue()));
    ...
    public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
        ...
        // Log.v(TAG, "onDescriptorWrite status=" + status + " uuid=" + chr.getUuid() + " descriptor=" +
        // descriptor.getUuid());
