...
*/
public class SDLSurface extends SurfaceView implements SurfaceHolder.Callback, View.OnApplyWindowInsetsListener,
    ...
    public WindowInsets onApplyWindowInsets(View v, WindowInsets insets) {
        if (Build.VERSION.SDK_INT >= 30 /* Android 11 (R) */) {
            Insets combined = insets.getInsets(WindowInsets.Type.systemBars() | WindowInsets.Type.systemGestures() |
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        do {
            ...
            if (toolType == MotionEvent.TOOL_TYPE_MOUSE) {
                ...
                SDLActivity.onNativePen(pointerId,
