...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    ...
    */
    ...
    public enum NativeState { INIT, RESUMED, PAUSED }
    ...
    protected String[] getLibraries() {
        // SDL3 is statically linked into snap_rhi_demo_app, so we only
        // need to load the application library — no separate libSDL3.so.
        return new String[] {
                             // "SDL3_image",
                             // "SDL3_mixer",
                             // "SDL3_net",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mBrokenLibraries) {
            String expected_version = String.valueOf(SDL_MAJOR_VERSION) + "." + String.valueOf(SDL_MINOR_VERSION) +
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN || keyCode == KeyEvent.KEYCODE_VOLUME_UP ||
            keyCode == KeyEvent.KEYCODE_CAMERA || keyCode == KeyEvent.KEYCODE_ZOOM_IN || /* API 11 */
    ...
    public static native void nativeSetScreenResolution(
        int surfaceWidth, int surfaceHeight, int deviceWidth, int deviceHeight, float density, float rate);
    ...
    public static native void onNativePen(
        int penId, int device_type, int button, int action, float x, float y, float p);
    ...
    public void setOrientationBis(int w, int h, boolean resizable, String hint) {
        ...
        Log.v(TAG,
              "setOrientation() requestedOrientation=" + req + " width=" + w + " height=" + h +
     ...
     */
    public int messageboxShowMessageBox(final int flags,
                                        final String title,
    ...
    private final Runnable rehideSystemUi = new Runnable() {
        ...
        public void run() {
            int flags = View.SYSTEM_UI_FLAG_FULLSCREEN | View.SYSTEM_UI_FLAG_HIDE_NAVIGATION |
                        ...
                        View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION | View.SYSTEM_UI_FLAG_LAYOUT_STABLE | View.INVISIBLE;
