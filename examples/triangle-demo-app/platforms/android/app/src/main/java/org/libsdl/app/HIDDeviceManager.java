...
public class HIDDeviceManager {
    ...
    private HashMap<BluetoothDevice, HIDDeviceBLESteamController> mBluetoothDevices =
    ...
    private boolean isXboxOneController(UsbDevice usbDevice, UsbInterface usbInterface) {
        ...
        if (usbInterface.getId() == 0 && usbInterface.getInterfaceClass() == UsbConstants.USB_CLASS_VENDOR_SPEC &&
        ...
        synchronized (this) {
            ...
            for (int interface_index = 0; interface_index < usbDevice.getInterfaceCount(); interface_index++) {
                ...
                if (isHIDDeviceInterface(usbDevice, usbInterface)) {
                    ...
                    // This happens with the Xbox Series X controller which has a duplicate interface 0, which is
                    // inactive
    ...
    native void HIDDeviceConnected(int deviceID,
                                   String identifier,
                                   int vendorId,
                                   int productId,
